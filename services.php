        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="media custom-media">
              ...
              <div class="media-body">
                <h5 class="mt-0">Set Meja Makan (Jumlah Sesuai Keinginan)</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="media custom-media">
              ...
              <div class="media-body">
                <h5 class="mt-0">Set Pintu dan Jendela (Bisa Custom Model)</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin..
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="media custom-media">
              ...
              <div class="media-body">
                <h5 class="mt-0">Set Meja dan Kursi (Bisa Custom Model)</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin..
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="media custom-media">
              ...
              <div class="media-body">
                <h5 class="mt-0">Set Perlengkapan Interior</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin..
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="media custom-media">
              ...
              <div class="media-body">
                <h5 class="mt-0">Produk Kayu Lain</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin..
              </div>
            </div>
          </div>
